    ...
    <div class="container pt-4 pb-4">
        <div class="border-dashed view-height">
            <div class="container w-25">
                ...
                <form:form method="post" action="/registration" modelAttribute="admin"
                           class="padding-small text-center">
                    <h1 class="text-color-darker">Rejestracja</h1>
                    <div class="form-group">
                        <form:input path="firstName" type="text" class="form-control" id="name" name="name"
                                    placeholder="podaj imię"/>
                    </div>
                    <div class="form-group">
                        <form:input path="lastName" type="text" class="form-control" id="surname" name="surname"
                    ...
                    <div class="form-group">
                        <form:input path="repassword" type="password" class="form-control" id="repassword"
